...
namespace VRatPolito.PrattiToolkit
{
    public static class Utility
    {
        ...
        /*
        public static async void WriteToCSV(string type, List<string> values, int fileindex)
        {
            var _sb StringBuilder = newStringBuilder();
            var csvSeparator = ";";
        ...
        public static async void WriteToCSVMulipleLines(string type, List<List<string>> lines, int fileindex)
        {
   ...
   */
    ...
    public static class UnityExtender
    {
        ...
        public static float DistancePointToLine(this Vector3 point, Vector3 lineStart, Vector3 lineEnd)
        {
            return Vector3.Magnitude(ProjectPointToLine(point, lineStart, lineEnd) - point);
        }
        ...
        /// <summary>
        /// Check if this mesh is in camera view frustum.
        /// </summary>
    ...
    public class FloatCircularBuffer : CircularBuffer<float>
    {
        ...
        private float Power
        {
            get
            {
                ...
                {
                    P += Math.Abs(sample) * Math.Abs(sample);
                }
                return P / Count;
            }
        }

        public FloatCircularBuffer(int capacity) : base(capacity)
        {
    ...
    public class IntCircularBuffer : CircularBuffer<int>
    {
        ...
        {
            get { return (int)Math.Round(_buffer.Average()); }
        }

        public int MovingMedian
        {
            get
            {
                var sortedBuffer = new List<int>(_buffer);
                sortedBuffer.Sort();
                return sortedBuffer[(int)(sortedBuffer.Count / 2)];
            }
        }
        public IntCircularBuffer(int windowSize, int preFill = 0) : base(windowSize)
        {
    ...
    public static class TransformExtender
    {
        ...
        public static void SetTransformFromData(this Transform t, TransformData data)
        {
