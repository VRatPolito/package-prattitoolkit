 ...
 */
        ...
        private readonly Stack<Action> _fixedExecutionQueue = new Stack<Action>();
        ...
        private void FixedUpdate()
        {
            ...
            {
                while (_fixedExecutionQueue.Count > 0)
                {
                    _fixedExecutionQueue.Pop().Invoke();
                    _fixedExecutionQueue.Clear();
                }
            }
        }
        ...
        public void FixedEnqueue(Action action)
        {

            lock (_fixedExecutionQueue)
            {
                _fixedExecutionQueue.Push(action);
            }
